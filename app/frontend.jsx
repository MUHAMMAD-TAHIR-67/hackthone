        ...
        <TouchableOpacity className="mr-4 bg-white rounded-2xl overflow-hidden shadow-lg w-72">
            ...
            <View className="p-4">
                <View className="flex-row justify-between items-center mb-2">
                    <Text className="text-sm font-semibold text-blue-500">{item.category}</Text>
        ...
        >
            ...
            <ScrollView className="flex-1">
                <View className="p-6 pt-12">
                    ...
                    <BlurView intensity={60} tint="light" className="rounded-3xl overflow-hidden mb-6">
                        <View className="p-6">
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mb-6">
                        {CATEGORIES.map((category) => (
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                                className={`items-center ${selectedCategory === category.name
                                    ? 'bg-blue-500'
                                    : 'bg-white'
                            ...
                            >
                                ...
                                />
                                <Text
                                    className={`mt-2 font-semibold text-center ${selectedCategory === category.name
                                        ? 'text-white'
                                        : 'text-gray-800'
                                        }`}
                                >
                    ...
                    <View className="mb-6">
                        <Text className="text-xl font-bold text-gray-800 mb-4">Recent Events</Text>
                        <FlatList
                            data={EVENTS}
                    ...
                    <View className="mb-6">
                        <Text className="text-xl font-bold text-gray-800 mb-4">Popular Events</Text>
                        <FlatList
